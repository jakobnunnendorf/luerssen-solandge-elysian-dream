    ...
    return (
        <div className="flex py-32 px-24 gap-20 ">
            ...
            <div className="w-[652px] flex-shrink-0 inline-block relative">
                <Image src="/dining.png" height={531} width={591} alt="Test" className="z-10 relative" />
                <div className="h-[531px] w-[591px] border rotate-3 absolute top-0 z-0 border-[#A37C45]"/>
            </div>
        </div>
    );
}
